...
public class PianoRoll extends JTable {
	...
	public void deleteSelectedRows(){
		parent.executeAction(new LineAction(parent,this.model, script, getSelectedRows(), LineAction.Type.DELETE));
	}

	public void replaceSelectedRows(InputLine[] rows){
		parent.executeAction(new LineAction(parent,model, script, getSelectedRows(), rows, LineAction.Type.REPLACE));
	}
